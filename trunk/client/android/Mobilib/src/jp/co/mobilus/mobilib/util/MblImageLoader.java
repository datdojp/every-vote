...
public abstract class MblImageLoader<T> {
    ...
    public MblImageLoader(MlImageLoaderLoadOrder loadOrder) {
                        ...
                        protected Void doInBackground(Void... params) {
                            try {
                                ...
                                if (getImageWidth() > 0 || getImageHeight() > 0) {
                                    bm = MblUtils.loadBitmapMatchSpecifiedSize(getImageWidth(), getImageHeight(), bmData);
                                } else {
    ...
    public synchronized static boolean loadInternalImage(
        ...
        if (MblUtils.isEmpty(path)) return false;
